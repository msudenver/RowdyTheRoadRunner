...
(function() {
  "use strict";
  var certifications, concentrations, degreeFinder, licensures, list, majors, masters, minors, regEx, vis;
  ...
  degreeFinder.controller("ProgramController", function($scope, $http) {
    var lookup;
