...
this.parentDiv.style.height=this._position.height+"px";this.parentDiv.style.overflow="hidden";this.parentDiv.style.zIndex=100000;this.parentDiv.style.backgroundColor=this._spud.getProperty('backgroundColor')||'white';if(/msie/i.test(navigator.userAgent))
